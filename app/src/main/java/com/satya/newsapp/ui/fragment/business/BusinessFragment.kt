...
import com.satya.newsapp.databinding.FragmentBusinessBinding
...
class BusinessFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProvider(this)[BusinessViewModel::class.java]
        viewModel.getListNewsBusiness()
